...
const IMAGES = [
  ...
  },
  {
    ...
    tag: 'חופשה',
    description:
      'היה כיף במיקונוס, לא ככה? לאט לאט, צוברים חוויות. עוד קצת מכאן, עוד קצת משם. המון מקומות, אנשים, נופים, צבעים. סוגרים כבר עשר שנים, והמסע שלכם עוד ממשיך, לעוד הרבה חוויות, נופים ומקומות. לבד וביחד, תמיד מוקפים באהבה',
  },
  {
